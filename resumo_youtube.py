...
bar = st.sidebar
bar.markdown("[![Bootcamp Nexa - Fundamentos de IA Generativa e Claude 3](https://github.com/ClaudioMendonca-Eng/dio-lab-natty-or-not/blob/main/img/logo_nexa_dio.png)](https://dio.me)")
